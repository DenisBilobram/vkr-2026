...
interface RegistryVerticalOnecloudInfoRepository : CrudRepository<RegistryVerticalOnecloudInfoEntity, UUID> {
    fun findByVerticalUid(verticalUid: UUID): RegistryVerticalOnecloudInfoEntity?
}
