...
interface RegistryServiceGatewayDetailsRepository : CrudRepository<RegistryServiceGatewayDetailsEntity, UUID> {
    fun findByServiceUid(serviceUid: UUID): RegistryServiceGatewayDetailsEntity?
}
