...
class BootstrapOfflineTogglesContextTask(
    ...
    override suspend fun executeCasted(taskRunContext: BootstrapRecomContext): TaskRunResult {
        runtimeLogger.info(
            "Bootstrapped offline Toggles context for ${taskRunContext.recommender.recommenderName}",
        )
    ...
    override fun transformContext(taskRunContext: BootstrapRecomContext): TogglesTenantTaskContext {
        return togglesTenantContextFactory.buildOffline(taskRunContext)
    }
}
