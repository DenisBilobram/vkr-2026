...
interface RegistryServiceYtProxyDetailsRepository : CrudRepository<RegistryServiceYtProxyDetailsEntity, UUID> {
    fun findByServiceUid(serviceUid: UUID): RegistryServiceYtProxyDetailsEntity?
}
