...
interface RegistryServiceWorkerDetailsRepository : CrudRepository<RegistryServiceWorkerDetailsEntity, UUID> {
    fun findByServiceUid(serviceUid: UUID): RegistryServiceWorkerDetailsEntity?
}
