...
@Table(schema = "registry", name = "service_platform_gateway_details")
data class RegistryServicePlatformGatewayDetailsEntity(
    @Id
    @Column("uid")
    ...
    @Column("base_shards_amount")
    val baseShardsAmount: Int?,
) : RegistryUidEntity
