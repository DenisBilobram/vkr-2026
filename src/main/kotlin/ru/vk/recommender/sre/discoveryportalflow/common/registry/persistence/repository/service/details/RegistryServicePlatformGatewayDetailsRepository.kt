...
interface RegistryServicePlatformGatewayDetailsRepository : CrudRepository<RegistryServicePlatformGatewayDetailsEntity, UUID> {
    fun findByServiceUid(serviceUid: UUID): RegistryServicePlatformGatewayDetailsEntity?
}
