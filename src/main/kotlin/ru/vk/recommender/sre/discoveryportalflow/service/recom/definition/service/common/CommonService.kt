package ru.vk.recommender.sre.discoveryportalflow.service.recom.definition.service.common
...
abstract class CommonService<TConfig : RecommenderServiceConfig>(
    type: ServiceType,
    serviceName: String,
    ...
    sharedTemplateDirectories: List<String> = listOf("shared/common"),
