...
interface RegistryServiceSnapshotsBuilderDetailsRepository : CrudRepository<RegistryServiceSnapshotsBuilderDetailsEntity, UUID> {
    fun findByServiceUid(serviceUid: UUID): RegistryServiceSnapshotsBuilderDetailsEntity?
}
