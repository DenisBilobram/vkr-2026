 ...
 */
data class BaseI2IServiceConfig(
    override val type: ServiceType = ServiceType.BASE_I2I,
    override val serviceDisabled: Boolean = false,
    override val shardsCount: Int = RecommenderServiceConfigDefaults.BASE_I2I_SHARDS_COUNT,
